...
import {searchPlace,addShop} from "@/api/services";
...
export default {
  ...
  created() {
    this.$store.dispatch('dataManage/getCity');
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file, type) {
      if (res.status === 1) {
        this.formData[type] = res.image_path;
      } else {
        ...
        <el-form :model="formData" :rules="rules" ref="formData" label-width="110px">
          ...
          <el-form-item label="上传店铺头像">
            <el-upload
              ...
              :on-success="(res, file) => handleAvatarSuccess(res, file, 'image_path')"
              :before-upload="beforeAvatarUpload">
              <img v-if="formData.image_path" :src="baseImgPath + formData.image_path" class="avatar" alt="">
          ...
          <el-form-item label="上传营业执照">
            <el-upload
              ...
              :action="baseUrl + 'v1/addimg/shop'"
              :show-file-list="false"
              :on-success="(res,file) => handleAvatarSuccess(res, file, 'business_license_image')"
              :before-upload="beforeAvatarUpload">
          ...
          <el-form-item label="上传餐饮服务许可证">
            <el-upload
              ...
              :action="baseUrl + 'v1/addimg/shop'"
              :show-file-list="false"
              :on-success="(res,file) => handleAvatarSuccess(res,file, 'catering_service_license_image')"
              :before-upload="beforeAvatarUpload">
              <img v-if="formData.catering_service_license_image"
                   :src="baseImgPath + formData.catering_service_license_image" class="avatar" alt="">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
